...
const envSchema = z.object({
  ...
  STORAGE_PROVIDER: z.enum(["local", "supabase", "google-drive"]).default("local"),
  ...
  GOOGLE_DRIVE_REFRESH_TOKEN: optionalString,
  GOOGLE_DRIVE_FOLDER_ID: optionalString,
  GOOGLE_DRIVE_PUBLIC_URL_TEMPLATE: optionalString,
